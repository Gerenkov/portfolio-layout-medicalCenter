...
/* harmony import */ var _components_comments__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/comments */ "./src/js/components/comments.js");
...
const commentsItemLenght = document.querySelectorAll('.comments__item').length;
...
if (commentsList) {
  loadMore.addEventListener('click', () => {
    ...
    if (visItems.length === commentsItemLenght) {
